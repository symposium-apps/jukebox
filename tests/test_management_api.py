...
class ManagementApiTest(unittest.TestCase):
    ...
    def test_complete_authenticated_management_flow(self) -> None:
        ...
        self.assertIn(b'<link rel="stylesheet" href="/static/link-import.css">', page)
        self.assertIn(b'<link rel="stylesheet" href="/static/media-player.css">', page)
        self.assertIn(b'<script src="/static/link-import.js"></script>', page)
        self.assertIn(b'<script src="/static/media-player.js"></script>', page)
